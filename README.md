...
###To run:
####Linux
  * `wget --no-check-certificate https://raw.github.com/BigMarker/railsready/master/railsready.sh && bash railsready.sh`

####OSX
  * `curl -O https://raw.github.com/BigMarker/railsready/master/railsready.sh && bash railsready.sh`
